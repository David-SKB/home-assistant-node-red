...
const CalculateAverageMotionDetectionIntervalAreaAutomation = require('../../../../../../../../domain/models/template/dynamic/area/motion/detection/CalculateAverageMotionDetectionIntervalAreaAutomation');

describe('CalculateAverageMotionDetectionIntervalAreaAutomation', () => {
  ...
  const file_name = (area_id) => `calculate_average_motion_detection_interval_${area_id}_automation.yaml`;
  ...
  it('should set default values correctly', () => {
    ...
    const template = new CalculateAverageMotionDetectionIntervalAreaAutomation(area_id);
  ...
  it('should generate the expected switch template', () => {
    ...
    const generated_template = new CalculateAverageMotionDetectionIntervalAreaAutomation(area_id, { area_name }).template;
