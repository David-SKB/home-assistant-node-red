...
const MotionLightingAutoMinimumTimeoutAreaSensor = require('../../../../../../../../domain/models/template/dynamic/area/motion/lighting/MotionLightingAutoMinimumTimeoutAreaSensor');

describe('MotionLightingAutoMinimumTimeoutAreaSensor', () => {
  ...
  const file_name = (area_id) => `motion_lighting_auto_minimum_timeout_${area_id}_sensor.yaml`;
  ...
  it('should set default values correctly', () => {
    ...
    const template = new MotionLightingAutoMinimumTimeoutAreaSensor(area_id);
  ...
  it('should generate the expected input_text template', () => {
    ...
    const generated_template = new MotionLightingAutoMinimumTimeoutAreaSensor(area_id, { area_name }).generate().payload;
