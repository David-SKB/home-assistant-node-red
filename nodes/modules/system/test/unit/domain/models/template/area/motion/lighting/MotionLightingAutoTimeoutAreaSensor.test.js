...
const MotionLightingAutoTimeoutAreaSensor = require('../../../../../../../../domain/models/template/dynamic/area/motion/lighting/MotionLightingAutoTimeoutAreaSensor');

describe('MotionLightingAutoTimeoutAreaSensor', () => {
  ...
  const file_name = (area_id) => `motion_lighting_auto_timeout_${area_id}_sensor.yaml`;
  ...
  it('should set default values correctly', () => {
    ...
    const template = new MotionLightingAutoTimeoutAreaSensor(area_id);
  ...
  it('should generate the expected input_text template', () => {
    ...
    const generated_template = new MotionLightingAutoTimeoutAreaSensor(area_id, { area_name }).generate().payload;
