...
const CalculateAverageMotionDetectionIntervalAreaToggleAutomation = require('../../../../../../../../domain/models/template/dynamic/area/motion/detection/CalculateAverageMotionDetectionIntervalAreaToggleAutomation');

describe('CalculateAverageMotionDetectionIntervalAreaToggleAutomation', () => {
  ...
  const file_name = (area_id) => `calculate_average_motion_detection_interval_${area_id}_toggle_automation.yaml`;
  ...
  it('should set default values correctly', () => {
    ...
    const template = new CalculateAverageMotionDetectionIntervalAreaToggleAutomation(area_id);
  ...
  it('should generate the expected switch template', () => {
    ...
    const generated_template = new CalculateAverageMotionDetectionIntervalAreaToggleAutomation(area_id, { area_name }).template;
