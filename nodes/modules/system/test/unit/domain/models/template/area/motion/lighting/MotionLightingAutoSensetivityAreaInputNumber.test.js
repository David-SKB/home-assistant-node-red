...
const MotionLightingAutoSensetivityAreaInputNumber = require('../../../../../../../../domain/models/template/dynamic/area/motion/lighting/MotionLightingAutoSensetivityAreaInputNumber');

describe('MotionLightingAutoSensetivityAreaInputNumber', () => {
  ...
  const file_name = (area_id) => `motion_lighting_auto_sensetivity_${area_id}_input_number.yaml`;
  ...
  it('should set default values correctly', () => {
    ...
    const template = new MotionLightingAutoSensetivityAreaInputNumber(area_id);
  ...
  it('should generate the expected input_text template', () => {
    ...
    const generated_template = new MotionLightingAutoSensetivityAreaInputNumber(area_id, { area_name }).generate().payload;
