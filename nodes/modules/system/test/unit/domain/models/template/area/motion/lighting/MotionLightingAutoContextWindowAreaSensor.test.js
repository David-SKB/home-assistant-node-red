...
const MotionLightingAutoContextWindowAreaSensor = require('../../../../../../../../domain/models/template/dynamic/area/motion/lighting/MotionLightingAutoContextWindowAreaSensor');

describe('MotionLightingAutoContextWindowAreaSensor', () => {
  ...
  const file_name = (area_id) => `motion_lighting_auto_context_window_${area_id}_sensor.yaml`;
  ...
  it('should set default values correctly', () => {
    ...
    const template = new MotionLightingAutoContextWindowAreaSensor(area_id);
  ...
  it('should generate the expected input_text template', () => {
    ...
    const generated_template = new MotionLightingAutoContextWindowAreaSensor(area_id, { area_name }).generate().payload;
