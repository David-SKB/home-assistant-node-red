...
const ConvertTargetToEntitiesScript = require('../../../../../../../domain/models/template/dynamic/domain/util/ConvertTargetToEntitiesScript');

describe('ConvertTargetToEntitiesScript', () => {
  ...
  const base_path = `/config/.storage/templates/domain/util/`;
  const file_name = `convert_target_to_entities_script.yaml`;
  ...
  it('should set default values correctly', () => {
    const template = new ConvertTargetToEntitiesScript();
  ...
  it('should generate the expected scene template', () => {
    ...
    const generated_template = new ConvertTargetToEntitiesScript().template;
