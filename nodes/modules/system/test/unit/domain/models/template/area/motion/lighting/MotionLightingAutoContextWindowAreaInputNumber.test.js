...
const MotionLightingAutoContextWindowAreaInputNumber = require('../../../../../../../../domain/models/template/dynamic/area/motion/lighting/MotionLightingAutoContextWindowAreaInputNumber');

describe('MotionLightingAutoContextWindowAreaInputNumber', () => {
  ...
  const file_name = (area_id) => `motion_lighting_auto_context_window_${area_id}_input_number.yaml`;
  ...
  it('should set default values correctly', () => {
    ...
    const template = new MotionLightingAutoContextWindowAreaInputNumber(area_id);
  ...
  it('should generate the expected input_text template', () => {
    ...
    const generated_template = new MotionLightingAutoContextWindowAreaInputNumber(area_id, { area_name }).generate().payload;
