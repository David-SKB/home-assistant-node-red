...
const MotionLightingAutoMaximumTimeoutAreaInputNumber = require('../../../../../../../../domain/models/template/dynamic/area/motion/lighting/MotionLightingAutoMaximumTimeoutAreaInputNumber');

describe('MotionLightingAutoMaximumTimeoutAreaInputNumber', () => {
  ...
  const file_name = (area_id) => `motion_lighting_auto_maximum_timeout_${area_id}_input_number.yaml`;
  ...
  it('should set default values correctly', () => {
    ...
    const template = new MotionLightingAutoMaximumTimeoutAreaInputNumber(area_id);
  ...
  it('should generate the expected input_text template', () => {
    ...
    const generated_template = new MotionLightingAutoMaximumTimeoutAreaInputNumber(area_id, { area_name }).generate().payload;
