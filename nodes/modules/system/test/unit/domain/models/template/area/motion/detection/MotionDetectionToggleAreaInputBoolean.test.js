...
const MotionDetectionToggleAreaInputBoolean = require('../../../../../../../../domain/models/template/dynamic/area/motion/detection/MotionDetectionToggleAreaInputBoolean');

describe('MotionDetectionToggleAreaInputBoolean', () => {
  ...
  const file_name = (area_id) => `motion_detection_toggle_${area_id}_input_boolean.yaml`;
  ...
  it('should set default values correctly', () => {
    ...
    const template = new MotionDetectionToggleAreaInputBoolean(area_id);
  ...
  it('should generate the expected input_boolean template', () => {
    const area_id = areas[0].id;
    ...
    const generated_template = new MotionDetectionToggleAreaInputBoolean(area_id, { area_name }).template;
