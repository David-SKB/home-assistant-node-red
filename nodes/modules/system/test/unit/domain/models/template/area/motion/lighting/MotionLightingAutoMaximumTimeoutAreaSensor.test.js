...
const MotionLightingAutoMaximumTimeoutAreaSensor = require('../../../../../../../../domain/models/template/dynamic/area/motion/lighting/MotionLightingAutoMaximumTimeoutAreaSensor');

describe('MotionLightingAutoMaximumTimeoutAreaSensor', () => {
  ...
  const file_name = (area_id) => `motion_lighting_auto_maximum_timeout_${area_id}_sensor.yaml`;
  ...
  it('should set default values correctly', () => {
    ...
    const template = new MotionLightingAutoMaximumTimeoutAreaSensor(area_id);
  ...
  it('should generate the expected input_text template', () => {
    ...
    const generated_template = new MotionLightingAutoMaximumTimeoutAreaSensor(area_id, { area_name }).generate().payload;
