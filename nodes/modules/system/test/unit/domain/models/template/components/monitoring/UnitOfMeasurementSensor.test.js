...
const UnitOfMeasurementSensor = require('../../../../../../../domain/models/template/components/monitoring/UnitOfMeasurementSensor');

describe('UnitOfMeasurementSensor', () => {
  ...
  const base_path = () => `/config/.storage/templates/components/monitoring/`;
  const file_name = () => `unit_of_measurement_sensor.yaml`;
  ...
  describe('constructor', () => {
    ...
    it('should set default values correctly', () => {
      const template = new UnitOfMeasurementSensor({});
      ...
      expect(template.iterable).toEqual([]);
    ...
    it('should set path using base_path and file_name when path is not provided', () => {
      ...
      expect(template.path).toBe(path.join(custom_base_path, custom_file_name));
    });
  ...
  describe('generate', () => {
    ...
    it('should return path and payload', () => {
      const area_id = areas[0].id;
      const template = new UnitOfMeasurementSensor(area_id, {});
