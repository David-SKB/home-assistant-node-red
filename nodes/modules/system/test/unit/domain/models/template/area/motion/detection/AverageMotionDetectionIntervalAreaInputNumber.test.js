...
const AverageMotionDetectionIntervalAreaInputNumber = require('../../../../../../../../domain/models/template/dynamic/area/motion/detection/AverageMotionDetectionIntervalAreaInputNumber');

describe('AverageMotionDetectionIntervalAreaInputNumber', () => {
  ...
  const file_name = (area_id) => `average_motion_detection_interval_${area_id}_input_number.yaml`;
  ...
  it('should set default values correctly', () => {
    ...
    const template = new AverageMotionDetectionIntervalAreaInputNumber(area_id);
  ...
  it('should generate the expected switch template', () => {
    ...
    const generated_template = new AverageMotionDetectionIntervalAreaInputNumber(area_id, { area_name }).template;
