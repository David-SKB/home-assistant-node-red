...
const AverageMotionDetectionDurationAreaSensor = require('../../../../../../../../domain/models/template/dynamic/area/motion/detection/AverageMotionDetectionDurationAreaSensor');

describe('AverageMotionDetectionDurationAreaSensor', () => {
  ...
  const file_name = (area_id) => `average_motion_detection_duration_${area_id}_sensor.yaml`;
  ...
  it('should set default values correctly', () => {
    ...
    const template = new AverageMotionDetectionDurationAreaSensor(area_id);
  ...
  it('should generate the expected switch template', () => {
    ...
    const generated_template = new AverageMotionDetectionDurationAreaSensor(area_id, { area_name }).template;
