...
class MotionLightingAutoMinimumTimeoutAreaSensor extends AreaTemplate {
  ...
  constructor(area_id, {
    ...
    super(area_id, { 
      ...
      file_name: `motion_lighting_auto_minimum_timeout_${area_id}_sensor.yaml`,
...
module.exports = MotionLightingAutoMinimumTimeoutAreaSensor;