...
class MotionLightingHybridTargetStateAreaInputText extends AreaTemplate {
...
`input_text:
  motion_lighting_hybrid_target_state_${area_id}:
    name: Motion Lighting Hybrid Target State ${area_name}`;

}

module.exports = MotionLightingHybridTargetStateAreaInputText;